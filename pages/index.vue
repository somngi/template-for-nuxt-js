        ...
        <div class="container">
          <div class="row">
            <div class="title-subtitle">
              ...
              <h1 class="title">
                Let's transform some higher level <span>ideas</span> into code.
              </h1>
              <!-- COIDEA:main:section:headline:title END -->

              <!-- COIDEA:main:section:headline:subtitle START -->
              <h2 class="subtitle">
                Web Design. Development. With ready-to-use examples.
              </h2>
        ...
        <section class="grid">
          <div class="container">
            <div class="row">
              ...
              <article v-for="(item, index) in items" :key="item.id" v-if="items && items.length > 0 && index <= limitationList">
                <div class="image">
              ...
              <div class="view-all">
                <nuxt-link to="/categories" class="load-more" title="VIEW ALL">VIEW ALL</nuxt-link>
